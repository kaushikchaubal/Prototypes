...
public class ServerV2 {
    ...
    public static void main(String[] args) {
        try {
            ...
            ServerV2 s = new ServerV2(System.out, 10);
...
//    HashMap<String, String> mapping = new HashMap<String, String>();
     ...
     **/
    public ServerV2(OutputStream logStream, int maxConnections) {
    	
    	
//    	mapping.put("http://www.shop.com/", "http://127.0.0.1:8088/shopClient/main.do");
    	
        setLogStream(logStream);
        log("Starting server");
        threadGroup = new ThreadGroup(ServerV2.class.getName());
    ...
    public static class Control implements Service {
        ServerV2 server;             // The server we control
	 ...
	 **/
        public Control(ServerV2 server, String password) {
            this.server = server;
